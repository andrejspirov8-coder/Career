...
from career_job_search.recruiters.hiring_models import ProfileCandidate
from career_job_search.recruiters.web_research import company_site_hits, web_search

try:
    from career_job_search.recruiters.ollama_agents import analyze_company
    from career_job_search.recruiters.ollama_client import agent_enabled
except ImportError:
    analyze_company = None  # type: ignore[misc, assignment]

    def agent_enabled(*_args: Any, **_kwargs: Any) -> bool:  # type: ignore[misc]
        return False
...
def score_company_from_text(
    ...
    *,
    ...
    sector_score = hiring.company_sector_score(candidate, hn_cfg)
