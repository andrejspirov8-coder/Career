...
def test_contract_pipeline_e2e():
    ...
    for helper in ["automation_control", "opportunity_dashboard", "recruiter_dashboard", "cv_catalogue", "cv_studio", "local_drafting", "notification_center", "search_preferences", "workspace_control", "career_analytics"]:
