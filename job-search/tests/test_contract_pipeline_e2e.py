...
def test_contract_pipeline_e2e():
    ...
    for helper in [
        ...
        "career_job_search.cvs.catalogue_cli",
        "career_job_search.cvs.studio",
        "career_job_search.cvs.drafting",
        "career_job_search.notifications.center",
        "career_job_search.opportunities.preferences",
        "career_job_search.workspace.control",
        "career_job_search.automation.analytics",
    ]:
    ...
    result = subprocess.run(
        ["npm", "test"], capture_output=True, text=True, cwd="dashboard"
    )
