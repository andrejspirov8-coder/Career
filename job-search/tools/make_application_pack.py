...
PACKS_PARENT = Path(__file__).resolve().parent.parent / "packs"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Force CV variant slug (luxury-retail | operations-management | it-business)",
    )
    parser.add_argument(
        "--packs-dir",
        type=Path,
    ...
    print(f"  Open README.txt inside the pack for paths and checklist.")
