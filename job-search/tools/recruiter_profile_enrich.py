...
from recruiter_linkedin_paths import CANDIDATES_VALIDATED_CSV, DEFAULT_LINKEDIN_CONFIG
from recruiter_web_discover import (
    guess_company_from_snippet,
    guess_location_from_snippet,
)
from recruiter_web_research import fetch_profile_contents
...
def enrich_rows_with_browser(
    ...
    *,
    ...
    with sync_playwright() as playwright:
        ...
        from linkedin_browser import PlaywrightLinkedInAutomator
