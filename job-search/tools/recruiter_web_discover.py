...
from linkedin_recruiter_bot import read_seen_profile_urls
...
from recruiter_match import match_recruiter_profile
from recruiter_ollama_agents import DiscoveryExtraction, extract_discovery_batch
from recruiter_ollama_client import agent_cfg, agent_enabled, llm_enabled
from recruiter_web_research import (
    WebSearchHit,
...
def draft_rank_fields(
    *,
    ...
    persona_dec = hn.classify_persona(candidate, hn_cfg)
    cv_dec = hn.match_candidate_to_cv(candidate, hn_cfg)
    rank_score = hn.rank_candidate(
        candidate, persona_dec, cv_dec, hn_cfg, hn.HistorySignals()
    )
